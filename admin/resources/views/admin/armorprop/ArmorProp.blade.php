            ...
            <div class="mt-[3rem] grid grid-cols-1 lg:grid-cols-3 sm:grid-cols-2 gap-3">
                ...
                <a href="" class="bg-gray-100 rounded-xl cursor-pointer">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-1 mx-3 mb-3">
                        <button class="bg-blue-500 rounded-md cursor-pointer hover:bg-blue-600 duration-300 text-white font-semibold ">Edit</button>
                        <button class="bg-red-500 rounded-md cursor-pointer hover:bg-red-600 duration-300 text-white font-semibold ">Hapus</button>
                    </div>
                 </a>
                @endforeach
            </div>
        </div>
        <a href="{{ route('armor.add') }}">
