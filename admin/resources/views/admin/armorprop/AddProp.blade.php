...
@section('content')
    <section class="box-border p-0 m-0 bg-gray-100 text-center justify-center items-center h-screen font-poppins overflow-auto">
        <div class="mt-[5rem] mr-[1rem] lg:mr-[10rem] ml-[2rem] lg:ml-[14rem] md:ml-[5rem] xss:ml-[3rem] sm:ml-[2rem] mb-[2rem]">
            ...
            <form class="mt-[5rem]" action="{{ route('armor.post') }}" enctype="multipart/form-data" method="POST">
              @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-[0.5rem]"">
                <div class="w-auto">
                  <label for="no_handphone" class="block text-gray-700 font-semibold mb-1">Harga</label>
                  <input type="number" id="no_handphone" name="harga" class="block w-full rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" />
                </div>
                <div class="w-auto">
                  <label for="no_handphone" class="block text-gray-700 font-semibold mb-1">Alamat</label>
                  <input type="text" id="no_handphone" name="alamat" class="block w-full rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" />
                </div>
                <div class="w-auto">
                  <label for="no_handphone" class="block text-gray-700 font-semibold mb-1">Alamat Lengkap</label>
                  <input type="text" id="no_handphone" name="alamat_lengkap" class="block w-full rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" />
                </div>
              </div>
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-[0.5rem]">
                ...
                <div class="w-auto">
                    ...
                    <input type="text" id="" name="kecamatan" class="block w-full rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" />
                </div>
              </div>
                <div class="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-4 mt-[0.5rem]"">
                    <div class="w-auto">
                      ...
                      <input type="number" id="no_handphone" name="bed" class="block w-full rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" />
                    </div>
                    <div class="w-auto">
                      <label for="no_handphone" class="block text-gray-700 font-semibold mb-1">Shower</label>
                      <input type="number" id="no_handphone" name="shower" class="block w-full rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" />
                    </div>
                    <div class="w-auto">
                      <label for="no_handphone" class="block text-gray-700 font-semibold mb-1">Luas Bangunan</label>
                      <input type="number" id="no_handphone" name="luas_bangunan" class="block w-full rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" />
                    </div>
                    <div class="w-auto">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="deskripsi" id="editor" class="w-full text-slate-500 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Enter keterangan" required></textarea>
                </div>
