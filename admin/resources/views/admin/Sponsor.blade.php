        ...
        @foreach ($sponsor as $item)
            ...
            <div class="bg-white rounded-3xl mx-4 md:mx-auto max-w-screen-md border-2 border-gray-400 mt-16">
                <div class="px-8 py-6 md:p-10">
                    <div class="flex">
                        <div class="font-display text-base text-slate-900 font-normal">item</div>
                        <div class="px-2 border-r-2 border-gray-200"></div>
                        <div class="font-display font-semibold text-base text-slate-900 px-2">sponsor</div>
                      </div>
                    <h2 class="text-3xl md:text-4xl font-medium leading-tight text-gray-800 mb-6">Wahitukam</h2>
                    <p class="text-base md:text-lg font-normal leading-normal text-gray-800 mb-6">jonathaniatsaherokuaugta@educourse.id</p>
