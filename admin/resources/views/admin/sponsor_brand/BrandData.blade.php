...
<section class="box-border p-0 m-0 bg-gray-200 text-center justify-center items-center h-screen font-poppins overflow-x-hidden">
    ...
    <div class="my-4 grid grid-cols-1 sm:flex gap-4">
      <div class="w-full">
        ...
        <input name="textarea" id="text" class=" w-full resize-none rounded-md border border-slate-300 p-5 text-gray-500" id="readonlyinput" readonly placeholder="{{ $branding->alamat }}"/>
      </div>
    </div>
