...
@section('content')
    <section class="box-border p-0 m-0 bg-gray-200 text-center justify-center items-center overflow-hidden font-poppins">
        <div class="text-center flex pt-[5rem] xss:mx-[3rem] xs:[3rem]">
            ...
            <h1 class="text-3xl text-gray-700 border border-gray-300 shadow-md shadow-gray-400 font-semibold bg-white mx-auto max-w-xs py-3 px-5 rounded-md">Laporan Triwulan</h1>
        </div>
