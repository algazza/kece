...
class NewsSeeder extends Seeder
{
    ...
    public function run()
    {
        $userData = [
            [
                'judul' => 'Dukung GENCARKAN, Bank Arto Moro Hadirkan Edukasi Keuangan di CFD',
                'keterangan' => '"Semarang – Otoritas Jasa Keuangan (OJK) meluncurkan program “Gencarkan” (Gerakan Nasional Cerdas Keuangan) sebagai bagian dari upaya strategis memperkuat inklusi keuangan nasional. Program ini merupakan respons terhadap hasil Survei Nasional Literasi dan Inklusi Keuangan (SNLIK) tahun 2024 yang diselenggarakan oleh OJK bekerja sama dengan BPS.

Hasil survei tersebut mengungkapkan bahwa tingkat inklusi keuangan di Indonesia saat ini mencapai 75,02 persen, sementara indeks literasi keuangan masyarakat Indonesia berada pada angka 65,43 persen. Temuan dari SNLIK 2024 menunjukkan adanya peluang signifikan untuk memperbaiki literasi dan inklusi keuangan di tanah air.

Dengan peluncuran program Gencarkan, OJK berkomitmen untuk terus mendorong inisiatif peningkatan literasi dan akses keuangan di seluruh lapisan masyarakat, sehingga Indeks Inklusi Keuangan Nasional mampu mencapai target sebesar 98 persen menyusul hadirnya Generasi Indonesia Emas pada tahun 2045.

Sejalan dengan tersebut, Bank Arto Moro, sebagai bank rural terbesar di Kota Semarang, secara rutin berpartisipasi dalam kegiatan Car Free Day (CFD) di Kawasan Simpang Lima Semarang. Mengusung tema “Cerdas Finansial untuk Semua,” Bank Arto Moro menyajikan berbagai kegiatan edukatif dan interaktif untuk mendukung program Gencarkan. Kegiatan ini menjadi platform efektif untuk menyampaikan pesan penting mengenai pemahaman dan akses masyarakat terhadap layanan keuangan.

Dalam booth yang dirancang secara interaktif dan menarik, Bank Arto Moro menyajikan berbagai kegiatan, termasuk literasi keuangan dasar, cek kesehatan tensi darah dan kolesterol, serta pembagian minuman isotonik dan bubur kacang hijau gratis. Selain itu, berbagai promo spesial juga tersedia bagi para pengunjung yang membuka rekening baru selama kegiatan.

Partisipasi Bank Arto Moro dalam CFD menegaskan komitmen mereka untuk memperluas cakupan literasi keuangan dan memastikan bahwa lebih banyak masyarakat memahami cara mengelola keuangan secara efektif dan optimal. Pentingnya literasi keuangan tidak dapat dipandang sebelah mata, mengingat tingkat literasi keuangan di Indonesia masih relatif rendah. Banyak masyarakat yang belum sepenuhnya memahami konsep perbankan, investasi, dan manfaat jangka panjang dari kebijakan keuangan.

Direktur Utama Bank Arto Moro, Darmawan S.Sos., MM., menjelaskan urgensi literasi keuangan. “Inklusi keuangan menjadi bagian integral dari pembangunan ekonomi yang berkelanjutan. Kami percaya bahwa dengan memberikan pemahaman keuangan yang tepat, kami dapat membantu masyarakat menjadi lebih cerdas dan mandiri secara finansial,” ujar Darmawan.

Darmawan juga menekankan pentingnya kegiatan literasi keuangan seperti ini untuk memperluas cakupan literasi keuangan dan memastikan bahwa setiap lapisan masyarakat memahami cara mengelola keuangan dengan efektif. “Kami berkomitmen memastikan setiap lapisan masyarakat, terutama di Kota Semarang memiliki akses yang sama terhadap layanan keuangan. Melalui berbagai inovasi dan program edukasi, kami terus berupaya menjangkau setiap individu,” tambah Darmawan.

“Kegiatan Car Free Day ini merupakan langkah nyata Bank Arto Moro dalam menghadapi tantangan inklusi keuangan nasional. Dengan meningkatkan literasi keuangan di masyarakat, kami turut berkontribusi dalam membangun generasi yang cerdas secara finansial,” tutup Darmawan."
',
                'kategory' => 'Pengumuman',
            ...
            [
                ...
                'keterangan' => 'SEMARANG ― Bank Arto Moro Semarang, Selasa (26/8), menandatangani kerja sama dalam bentuk linkage program dengan Bank Eka Lampung. Langkah ini diambil sebagai wujud komitmen Bank Arto Moro dalam mendukung perkembangan usaha mikro, kecil, dan menengah (UMKM) di wilayah Jawa Tengah, khususnya dalam aspek akses pembiayaan, peningkatan usaha, serta ekspansi pasar.

Penandatanganan perjanjian kerja sama dilaksanakan di kantor pusat Bank Arto Moro yang berlokasi di Jalan Elang Raya No. 99, Mangunharjo, Semarang. Dalam acara tersebut, penandatanganan perjanjian dilakukan oleh Prof. Dr. H. Subyakto, SH, MH, MM, Komisaris Utama sekaligus Pemegang Saham Pengendali Bank Arto Moro; Darmawan S.Sos., MM, Direktur Utama Bank Arto Moro; dan Eko Budiyono, Direktur Utama Bank Eka Lampung.

Dalam sambutannya, Direktur Utama Bank Arto Moro, Darmawan S.Sos., MM, mengungkapkan komitmennya untuk mendukung kebangkitan industri UMKM di Semarang dan Jawa Tengah. “Kami meyakini bahwa dengan dukungan yang tepat dan akses pasar yang lebih luas, UMKM di Jawa Tengah mampu menghadapi berbagai tantangan dan berkembang pesat. Kami berkomitmen untuk menyediakan berbagai bentuk dukungan yang diperlukan agar UMKM dapat terus tumbuh,” ujar Darmawan.

Direktur Utama Bank Arto Moro menyatakan keyakinannya bahwa kerja sama linkage yang baru saja terjalin dengan Bank Eka Lampung merupakan strategi fundamental dalam meningkatkan efisiensi dan aksesibilitas layanan keuangan kepada masyarakat. Menurut Darmawan, kerja sama ini merupakan langkah progresif untuk mendukung pertumbuhan ekonomi yang lebih besar bagi komunitas lokal.

“Kami percaya kerja sama ini akan memberikan manfaat signifikan, dengan harapan dapat memperluas akses layanan keuangan untuk masyarakat, sekaligus meningkatkan kualitas layanan yang kami sediakan,” ungkap Darmawan.

Lebih lanjut, Darmawan menjelaskan bahwa kolaborasi ini diharapkan dapat memberikan dampak positif bagi masyarakat sekitar, khususnya dalam sektor perekonomian mikro. “Dengan meningkatnya akses ke layanan keuangan yang lebih baik, kami yakin dapat mendorong pertumbuhan ekonomi melalui penyaluran kredit yang lebih lancar dan tepat sasaran,” tambahnya.

Sebagai informasi, selain menjalin kerja sama dengan Bank Eka Lampung, Bank Arto Moro juga telah mengadakan kerja sama serupa dengan berbagai lembaga keuangan lainnya, seperti Bank Jateng, Bank BJB, Bank Lestari Group, Bank DKI, Bank DIY, Bank Mayapada, OK! Bank Denpasar, dan Bank UMKM Jatim. “Kami berharap kerja sama dengan Bank Eka Lampung ini akan semakin memperkuat penyaluran pembiayaan kepada pelaku UMKM, sehingga mereka dapat terus berkembang dengan baik,” pungkas Darmawan.

Direktur Utama Bank Eka Lampung, Eko Budiyono, menyatakan bahwa kolaborasi dalam perjanjian kerja sama linkage dengan Bank Arto Moro akan memperkuat posisi pasar kedua institusi, serta memberikan nilai tambah signifikan bagi masyarakat dan perekonomian nasional. Menurut Eko, penguatan hubungan ini diharapkan dapat menciptakan ekosistem perbankan yang lebih sehat, berdaya saing tinggi, dan siap menghadapi berbagai peluang serta tantangan.

“Dengan terus memperkuat hubungan, kami yakin akan membentuk ekosistem perbankan yang lebih solid serta kompetitif. Ini akan memungkinkan kami untuk menghadapi berbagai tantangan dan memanfaatkan peluang dengan lebih baik,” ujar Eko Budiyono.
...
Komisaris Utama BPR Lingga Sejahtera, Rimbun Situmorang, menyatakan bahwa Bank Arto Moro telah dikenal luas sebagai lembaga keuangan profesional dengan standar pelayanan yang tinggi “Kegiatan studi banding ini sangat berharga bagi kami. Kami memperoleh banyak pelajaran berharga dari pengalaman Bank Arto Moro dalam memberikan layanan terbaik. Kami berharap dapat menerapkan ilmu yang kami peroleh untuk meningkatkan kualitas layanan di BPR Lingga Sejahtera,” jelas Rimbun.
...
Kegiatan ini tidak hanya memperkuat hubungan antara kedua lembaga tetapi juga membuka peluang untuk kolaborasi lebih lanjut di masa depan, demi kemajuan sektor perbankan dan UMKM di Indonesia. Darmawan berharap bahwa melalui pertukaran pengetahuan, pengalaman, dan sumber daya, kedua BPR dapat meningkatkan kualitas layanan dan memberikan dampak yang lebih signifikan bagi masyarakat di wilayah masing-masing. “Melalui kegiatan ini, kami berharap semua pihak dapat mengimplementasikan strategi yang lebih inovatif dan efektif dalam menghadapi tantangan industri perbankan yang terus berkembang,” tutup Darmawan.',
            ...
            [
                ...
                'keterangan' => 'SEMARANG ― Wirausahawan muda memiliki potensi besar untuk menjadi motor penggerak perekonomian, utamanya di sektor UMKM yang dianggap menjadi tulang punggung pertumbuhan ekonomi nasional. Generasi muda milenial yang berani terjun di dunia bisnis merupakan aset berharga bagi perekonomian Indonesia.
