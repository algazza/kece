                ...
                <form action="{{ route('laporan.post') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col items-center justify-center text-center cursor-pointer gap-1 p-[1rem]">
                        ...
                        <div class="mt-4 px-[2rem] w-full">
                            <input type="text" name="tanggal" class="rounded-[5px] block p-2.5 w-full z-20 text-sm text-gray-900 text-center shadow-gray-400" placeholder="Deskripsi singkat"/>
                            <input type="hidden" name="jenis_laporan" value="">
                           </div>
                        <div class="mt-4 mb-2">
