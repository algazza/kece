...
@section('content')
    <section class="box-border p-0 m-0 bg-gray-200 text-center justify-center items-center  font-poppins">
        ...
        <div class="flex flex-col md:flex-row h-auto  mt-[-1rem] gap-8 justify-center">
            <div class="block  bg-gray-200 text-left overflow-auto h-[105%] mt-[0.5rem]">
                @if (Auth::user()->role == 'kredit' || Auth::user()->role == 'admin')
                    <a href="{{ route('kredit.index') }}">
                        <div class="w-[35rem] h-[4.4rem] bg-gray-100 rounded-[5px] my-[0.6rem] box-border border-[0.5px] border-black shadow-md cursor-pointer hover:bg-gray-200 hover:scale-95 duration-300 ">
                            <div class="flex">
                ...
                @endif
                <a href="">
                    <div class="w-[35rem] h-[4.4rem] bg-gray-50 rounded-[5px] my-[0.6rem] box-border border-[0.5px] border-black shadow-md cursor-pointer hover:bg-gray-200 hover:scale-95 duration-300">
                        <div class="flex">
                            <div class="text-[3.5rem] mt-[-0.1rem] mx-[1.5rem]">
                                <i class='text-black bx bx-credit-card' ></i>
                            </div>
            ...
            <div class="bg-gray-50 w-[35rem] my-[1rem] rounded-[5px] h-[100%] box-border border-[0.5px] border-black shadow-lg relative">
