...
<div class="flex justify-end">
  ...
  <div class="flex gap-[1.5rem] pt-[5rem] pb-[2rem] px-[10rem] bg-gray-200 w-screen">
                    <img class=" bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShPq0XGv-4wIxCVB_qHi42ZqrmFr-Aw5Tl-g&s')] w-[15rem] h-[10rem] block justify-center rounded-[5px] box-border border-[0.5px] border-black shadow-lg">
