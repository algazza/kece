            ...
            <div class="mx-[1rem] mt-[1.5rem]">
                ...
                <div class="flex flex-col mx-[3.7rem] my-[1.3rem] gap-2">
                    <div class="flex gap-5">
                        ...
                        <p class="leading-7">{{ $pickup->email }}</p>
                    </div>
                    <div class="flex gap-5">
                        <i class='bx bxs-bell text-[1.4rem] mt-[0.2rem]'></i>
                        <p class="leading-7">{{ $pickup->no_handphone }}</p>
                    </div>
                    <div class="flex gap-5">
                        <i class='bx bxs-bell text-[1.4rem] mt-[0.2rem]'></i>
                        <p class="leading-7">{{ $pickup->nik }}</p>
                    </div>
                    <div class="flex gap-5">
                        <i class='bx bxs-bell text-[1.4rem] mt-[0.2rem]'></i>
                        <p class="leading-7">{{ $pickup->pekerjaan }}</p>
                    </div>
                    <div class="flex gap-5">
                        <i class='bx bxs-bell text-[1.4rem] mt-[0.2rem]'></i>
                        <p class="leading-7">{{ $pickup->alamat }}</p>
                    </div>
            ...
            <div class="mx-[1rem] mt-[2.5rem]">
                ...
                <div class="flex flex-col mx-[3.7rem] my-[1.3rem] gap-3">
                    <div class="flex gap-5">
                        ...
                        <p class="leading-7 text-[1rem]">{{ $pickup->total_pinjaman }}</p>
                    </div>
                    <div class="flex gap-5">
                        <i class='bx bxs-bell text-[1.5rem] mt-[0.2rem]'></i>
                        <p class="leading-7 text-[1rem]">{{ $pickup->jangka_waktu }}</p>
                    </div>
                    <div class="flex gap-5">
                        <i class='bx bxs-bell text-[1.5rem] mt-[0.2rem]'></i>
                        <p class="leading-7 text-[1rem]">{{ $pickup->jenis_angunan }}</p>
                    </div>
                    <div class="flex gap-5">
                        <i class='bx bxs-bell text-[1.5rem] mt-[0.2rem]'></i>
                        <p class="leading-7 text-[1rem]">{{ $pickup->perhitungan_bunga }}</p>
                    </div>
                    <div class="flex gap-5">
                        <i class='bx bxs-bell text-[1.5rem] mt-[0.2rem]'></i>
                        <p class="leading-7 text-[1rem]">{{ $pickup->bunga_pertahun }}</p>
                    </div>
                    <div class="flex gap-5">
                        <i class='bx bxs-bell text-[1.5rem] mt-[0.2rem]'></i>
                        <p class="leading-7 text-[1rem]">{{ $pickup->penghasilan_perbulan }}</p>
                    </div>
                </div>
            </div>  
        </div>
