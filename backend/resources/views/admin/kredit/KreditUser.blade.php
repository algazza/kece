            ...
            <div class="md:flex-1 px-1">
                ...
                <div class="grid gap-2 grid-cols-1 sm:grid-cols-3">
                  <div class="mt-2">
                      ...
                      <input type="text" id="name" name="name" placeholder="{{ $kredit->no_handphone }}" class="border border-gray-300 shadow p-3 w-full rounded ">
                  </div>
                  <div class="mt-2">
                      <label for="name" class="block mb-2 font-bold text-black">Email</label>
                      <input type="text" id="name" name="name" placeholder="{{ $kredit->email }}" class="border border-gray-300 shadow p-3 w-full rounded ">
                  </div>
                  <div class="mt-2">
                      <label for="name" class="block mb-2 font-bold text-black">NIK</label>
                      <input type="text" id="name" name="name" placeholder="{{ $kredit->nik }}" class="border border-gray-300 shadow p-3 w-full rounded ">
                  </div>
                  </div>
                  <div class="grid gap-2 grid-cols-1 sm:grid-cols-1">
                    <div class="mt-2">
                        <label for="name" class="block mb-2 font-bold text-black pr-2">Pekerjaan</label>
                        <input type="text" id="name" name="name" placeholder="{{ $kredit->pekerjaan }}" class="border border-gray-300 shadow p-3 w-full rounded ">
                    </div>
                </div>          
                  <div class="grid gap-2 grid-cols-1 sm:grid-cols-1">
                    <div class="mt-2">
                        <label for="name" class="block mb-2 font-bold text-black pr-2">Alamat</label>
                        <input type="text" id="name" name="name" placeholder="{{ $kredit->alamat }}" class="border border-gray-300 shadow p-3 w-full rounded ">
                    </div>
                </div>          
                  <div class="grid gap-2 grid-cols-1 sm:grid-cols-4">
                    <div class="mt-2">
                        ...
                        <input type="text" id="name" name="name" placeholder="{{ $kredit->total_pinjaman }}" class="border border-gray-300 shadow p-3 w-full rounded ">
                    </div>
                    <div class="mt-2">
                        <label for="name" class="block mb-2 font-bold text-black pr-2">Jangka Waktu</label>
                        <input type="text" id="name" name="name" placeholder="{{ $kredit->jangka_waktu }}" class="border border-gray-300 shadow p-3 w-full rounded ">
                    </div>
                    <div class="mt-2">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="text" id="name" name="name" placeholder="{{ $kredit->perhitungan_bunga }}" class="border border-gray-300 shadow p-3 w-full rounded ">
                    </div>
                </div>    
                <div class="grid gap-2 grid-cols-1 sm:grid-cols-1">
                  <div class="mt-2">
                      <label for="name" class="block mb-2 font-bold text-black pr-2">Code</label>
                      <input type="text" id="name" name="name" placeholder="{{ $kredit->code }}" class="border border-gray-300 shadow p-3 w-full rounded ">
                  </div>
              </div>         
                <div class="grid gap-2 grid-cols-1 sm:grid-cols-1">
                  <div class="mt-2">
                      <label for="name" class="block mb-2 font-bold text-black pr-2">Penghasilan</label>
                      <input type="text" id="name" name="name" placeholder="{{ $kredit->penghasilan_perbulan }}" class="border border-gray-300 shadow p-3 w-full rounded ">
                  </div>
              </div>         
                <div class="grid gap-2 grid-cols-1 sm:grid-cols-1">
                  <div class="mt-2">
                      <label for="name" class="block mb-2 font-bold text-black pr-2">Penghasilan</label>
                      <textarea type="text" id="name" name="name" class="border border-gray-300 shadow p-3 w-full rounded ">{{ $kredit->catatan }}</textarea>
                  </div>
              </div>         
            </div>
        </div>
