  ...
  <div class="p-8">
    ...
    <div class="my-4 flex gap-4">
      <div class="w-full">
        ...
        <textarea name="textarea" id="text" class=" w-full resize-none rounded-md border border-slate-300 p-5 text-gray-500" id="readonlyinput" readonly>{{ $kredit->alamat }}</textarea>
      </div>
    </div>
    ...
    <div class="my-4 flex gap-4">
      <div class="w-full">
        ...
        <textarea name="textarea" id="text" class=" w-full resize-none rounded-md border border-slate-300 p-5 text-gray-500" id="readonlyinput" readonly>{{ $kredit->catatan }}</textarea>
      </div>
    </div>
