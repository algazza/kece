...
class BannerController extends Controller
{
    ...
    public function update(Request $request, $id) {
        try {
            ...
            $banner->save(); // Gunakan save untuk update data yang sudah ada
    
            return redirect()->route('banner')->with('success', 'Banner berhasil diubah');
        } catch (\Exception $e) {
            return redirect()->route('banner')->with('error', 'Banner gagal diubah');
        }
    }
