...
const Home = () => {
  ...
  return (
    <>
      ...
      <section
        className={`${styles.paddingX} md:grid md:grid-cols-2 items-end bg-biruMuda-100 relative`}
      >
      ...
      <section className={`${styles.paddingY} ${styles.paddingX}`}>
        ...
        {openModal && <YoutubePopup handleModal={handleModal} />}
      </section>

      <span className="-mt-[100px] pb-[100px] block" id="berita">
        &nbsp;
      </span>
